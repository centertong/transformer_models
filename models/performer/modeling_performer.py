...
class PerformerPooler(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class PerformerPredictionHeadTransform(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.dense = nn.Linear(config.hidden_size, config.hidden_size)
        if isinstance(config.hidden_act, str):
...
class PerformerLMPredictionHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.transform = PerformerPredictionHeadTransform(config)
...
class PerformerOnlyMLMHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.predictions = PerformerLMPredictionHead(config)
...
class PerformerModel(PerformerPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.pooler = PerformerPooler(config) if add_pooling_layer else None
...
class PerformerForMaskedLM(PerformerPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = PerformerModel(config, add_pooling_layer=False)
        self.cls = PerformerOnlyMLMHead(config)
...
class PerformerForSequenceClassification(PerformerPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = PerformerModel(config)
        classifier_dropout = (
